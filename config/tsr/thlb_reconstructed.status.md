...
- Generated UTC: `2026-06-26T13:59:08.476964+00:00`
...
- Runtime history copy: `runtime/logs/tsr/thlb_reconstructed_status_report-20260626T135908Z.md`
...
- LU-wise reconstructed runtime: `3.24 min`
...
- Source-layer load time: `1.57 s`
- Candidate-query time: `1.70 s`
- Exact-overlay / fallback time: `56.75 s`
- Chunk-write time: `21.15 s`
- Final merge time: `1.23 s`

### Slowest Steps

- `tfl6_nd_100_established_ogma` | mode=`fragment_overlay` | status=`applied` | total=`33.62 s` | overlay=`29.12 s` | LU chunks=`9` | source features=`164`
- `tfl6_nd_080_riparian` | mode=`fragment_overlay` | status=`applied` | total=`10.34 s` | overlay=`5.34 s` | LU chunks=`10` | source features=`991`
- `tfl6_nd_120_wha` | mode=`fragment_overlay` | status=`applied` | total=`7.63 s` | overlay=`2.98 s` | LU chunks=`9` | source features=`45`
- `tfl6_nd_130_recreation` | mode=`fragment_overlay` | status=`applied` | total=`4.92 s` | overlay=`1.43 s` | LU chunks=`5` | source features=`25`
- `tfl6_nd_090_uwr` | mode=`fragment_overlay` | status=`applied` | total=`4.91 s` | overlay=`1.76 s` | LU chunks=`6` | source features=`22`
...
- AFLB/LHLB companion checkpoints were generated by the runner but are not part
  of the P4 handoff contract. Regenerate them deliberately if a later restart
  workflow needs them.
